        ...
        while( $row = mysqli_fetch_array($consultar) ) {
           ...
           ?>
            ...
            <tr class="centrar">
                ...
                <td>
                    <button <?php echo $dtnDesabilita?> type="button" class="RestPass btn btn-outline-warning btn-sm activo" id="btnResetPass<?php echo $varGral?><?php echo $n?>" onclick="rescon('<?php echo $id?>')">
